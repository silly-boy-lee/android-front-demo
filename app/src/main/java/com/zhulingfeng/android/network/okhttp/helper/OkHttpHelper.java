...
public class OkHttpHelper {
    ...
    /**
     * @FieldName: httpHelper
     * @description: 系统辅助参数定义
     */
    private HttpHelper httpHelper;
    /**
     * @FieldName: downUpLoadHelper
     * @description: 文件上传/下载辅助参数定义
     */
    private DownUpLoadHelper downUpLoadHelper;
    /**
     * @FieldName: downloadFileInfo
     * @description: 文件下载信息类
     */
    private DownloadFileInfo downloadFileInfo;
    /**
     * @FieldName: uploadFileInfo
     * @description: 文件上传信息类
     */
    private UploadFileInfo uploadFileInfo;
    /**
     * @FieldName: clientBuilder
     * @description: okHttp请求客户端建造器
     */
