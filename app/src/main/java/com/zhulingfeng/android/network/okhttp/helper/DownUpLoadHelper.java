...
import com.zhulingfeng.android.network.okhttp.annotation.DownloadStatus;
...
import com.zhulingfeng.android.network.okhttp.progress.ProgressRequestBody;
import com.zhulingfeng.android.network.okhttp.progress.ProgressResponseBody;
import com.zhulingfeng.android.network.okhttp.util.EncryptUtil;
import com.zhulingfeng.android.network.okhttp.util.MediaTypeUtil;
...
/**
 * @ClassName: DownUpLoadHelper
 * @description: 上传/下载业务类
 * @author:  Mr.Lee
 */
class DownUpLoadHelper extends BaseHelper{
    ...
    /**
     * @FieldName: downloadTaskMap
     * @description: 下载任务map类
     */
