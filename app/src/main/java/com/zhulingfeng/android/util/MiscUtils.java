...
public class MiscUtils {
    ...
    /**
     * @FieldName: APP_FOLDER_ON_SD
     * @description: sd卡中的文件夹
     */
    ...
    /**
     * @MethodName: hasStorage
     * @description: 检测sd卡是否还为存储空间
     * @author:  Mr.Lee
     */
    ...
    /**
     * @MethodName: updateFileTime
     * @description: 更新文件的修改日期
     * @author:  Mr.Lee
     * @param dir  目标文件
     * @param fileName  文件名
     */
    ...
    public static int getPhoneSDK(Context mContext) {
        TelephonyManager phoneMgr = (TelephonyManager) mContext.getSystemService(
                Context.TELEPHONY_SERVICE);
        int sdk = 7;
        try {
    ...
    /**
     * @MethodName: isSDCardSizeOverflow
     * @description:
     * @author:  Mr.Lee
     * @return    SDCard
     */
