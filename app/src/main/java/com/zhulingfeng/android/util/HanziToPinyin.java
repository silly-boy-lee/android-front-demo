...
public class HanziToPinyin {
    ...
    /**
     * @FieldName: DEBUG
     * @description: 当想检查内部数据结构时，打开此标志
     */
    private static final boolean DEBUG = false;
    /**
     * @FieldName: UNIHANS
     * @description: UNIHANS字符数组
     */
    ...
    /**
     * @FieldName: FIRST_PINYIN_UNIHAN
     * @description: First and last Chinese character with known Pinyin according to zh collation
     */
    ...
    /**
     * @FieldName: FIRST_UNIHAN
     * @description: The first Chinese character in Unicode block
     */
    ...
    public static class Token {
        /**
         * @FieldName: SEPARATOR
         * @description: Separator between target string for each source char
         */
        ...
        /**
         * @FieldName: type
         * @description: Type of this token, ASCII, PINYIN or UNKNOWN.
         */
        public int type;
        /**
         * @FieldName: source
         * @description: Original string before translation.
         */
        public String source;
        /**
         * @FieldName: target
         * @description: Translated string of source. For Han, target is corresponding Pinyin.
         * Otherwise target is
    ...
    /**
     * @MethodName: doSelfValidation
     * @description: Validate if our internal table has some wrong value.
     * @author:  Mr.Lee
    ...
    /**
     * @MethodName: get
     * @description: Convert the input to a array of tokens. The sequence of ASCII or Unknown
     * characters without
