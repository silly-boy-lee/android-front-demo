...
public class ArrayUtils {
    /**
     * @MethodName:: search
     * @description: 在数组objects中搜索元素element
     * @author:  Mr.Lee
     * @param objects 待操作的数组
     * @param element 待匹配的元素
     * @return 元素在数组中的索引，如不存在，-1
     */
    ...
    /**
     * @MethodName:: sortingByChoose
     * @description: 使用选择排序法，对数组intArray进行排序
     * @author:  Mr.Lee
    ...
    /**
     * @MethodName: sortingByInsert
     * @description: 使用插入排序法，对数组intArray进行排序
     * @author:  Mr.Lee
     * @param intArray 待排序的数组
     * @param ascending 升序
     */
    ...
    /**
     * @MethodName: sortingByBubbling
     * @description: 使用冒泡排序法，对数组intArray进行排序
     * @author:  Mr.Lee
     * @param intArray 待排序的数组
     * @param ascending 升序
     */
    ...
    /**
     * @MethodName: sortingByFastRecursion
     * @description: 使用递归快排法，对数组intArray进行排序
     * @author:  Mr.Lee
     * @param intArray 待排序的数组
    ...
    /**
     * @MethodName: sortingByFastStack
     * @description: 使用栈快排法，对数组intArray进行排序
     * @author:  Mr.Lee
     * @param intArray 待排序的数组
     * @param ascending 升序
     */
    ...
    /**
     * @MethodName: integersToInts
     * @description:  将Integer数组转换成int数组
     * @author:  Mr.Lee
     * @param integers 待操作数组
     * @return int数组
     */
    ...
    /**
     * @MethodName: toString
     * @description: 将给定的数组转换成字符串，默认分隔符为", "
     * @author:  Mr.Lee
     * @param integers 给定的数组
     * @return 例如：1, 2, 3
     */
