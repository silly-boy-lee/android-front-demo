...
public class ChannelUtil {
    ...
    /**
     * @FunctionName: getChannelFromApk
     * @description: 从apk中获取版本信息
     * @author:  Mr.Lee
     * @param context
     * @param channelKey
     * @return
    ...
    /**
     * @FunctionName: saveChannelBySharedPreferences
     * @description: 本地保存channel & 对应版本号
     * @author:  Mr.Lee
     * @param context
     * @param channel
     */
    ...
    /**
     * @FunctionName: getChannelBySharedPreferences
     * @description: 从sp中获取channel
     * @author:  Mr.Lee
     * @param context
    ...
    /**
     * @FunctionName: getVersionCode
     * @description: 从包信息中获取版本号
     * @author:  Mr.Lee
     * @param context
     * @return
     */
