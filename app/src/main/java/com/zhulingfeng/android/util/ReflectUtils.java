...
public class ReflectUtils {
    ...
    /**
     * @MethodName: getField
     * @description: 从指定的类中获取指定的字段，默认获取Declared类型的字段、向上查找
     * @author:  Mr.Lee
     * @param sourceClass 指定的类
     * @param fieldName 要获取的字段的名字
     * @return
    ...
    /**
     * @MethodName: getMethod
     * @description: 从指定的类中获取指定的方法，默认获取Declared类型的方法、向上查找
     * @author:  Mr.Lee
     * @param sourceClass 指定的类
    ...
    /**
     * @MethodName: getMethod
     * @description: 从指定的类中获取指定名称的不带任何参数的方法，默认获取Declared类型的方法并且向上查找
     * @author:  Mr.Lee
     * @param sourceClass 指定的类
     * @param methodName 方法名
     * @return
    ...
    /**
     * @MethodName: getValueOfMethod
     * @description: 获取给定的类中指定参数类型的ValuOf方法
     * @author:  Mr.Lee
     * @param sourceClass 给定的类
     * @param methodParameterTypes 方法参数类型
     ...
     * @description: 获取给定的类中给定参数类型的构造函数
     * @author:  Mr.Lee
     * @param sourceClass 给定的类
    ...
    /**
     * @MethodName: getSuperClasss
     * @description: 获取给定的类所有的父类
     * @author:  Mr.Lee
     * @param sourceClass 给定的类
    ...
    /**
     * @MethodName: getObjectByFieldName
     * @description: 取类中指定属性的值
     * @author:  Mr.Lee
     * @param object
     * @param fieldName
     * @param clas
    ...
    /**
     * @MethodName: isArrayByType
     * @description: 判断给定字段是否是type类型的数组
     * @author:  Mr.Lee
     * @param field
     * @param type
     * @return
    ...
    /**
     * @MethodName: isCollectionByType
     * @description: 判断给定字段是否是type类型的collectionType集合，例如collectionType=List.class，type=Date.class就是要判断给定字段是否是Date类型的List
     * @author:  Mr.Lee
     * @param field
