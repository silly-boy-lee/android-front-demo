...
public class DeviceStatusUtils {
    /**
     * @MethodName: DeviceStatusUtils
     * @description: Don't let anyone instantiate this class.
     * @author:  Mr.Lee
     */
    ...
    /**
     * @MethodName: getScreenBrightnessModeState
     * @description: 获取系统屏幕亮度模式的状态，需要WRITE_SETTINGS权限
     * @author:  Mr.Lee
     * @param context  上下文
    ...
    /**
     * @MethodName: 
     * @description: 判断系统屏幕亮度模式是否是自动，需要WRITE_SETTINGS权限
     * @author:  Mr.Lee
     * @param context 上下文
    ...
    /**
     * @MethodName:
     * @description: 设置系统屏幕亮度模式，需要WRITE_SETTINGS权限
     * @author:  Mr.Lee
     * @param context 上下文
     * @param auto 自动
     * @return 是否设置成功
     ...
     * @description: 获取系统亮度，需要WRITE_SETTINGS权限
     * @author:  Mr.Lee
     * @param context 上下文
     ...
     * @description: 设置系统亮度（此方法只是更改了系统的亮度属性，并不能看到效果。要想看到效果可以使用setWindowBrightness()方法设置窗口的亮度），
     * 需要WRITE_SETTINGS权限
     * @author:  Mr.Lee
     * @param context  上下文
    ...
    /**
     * @MethodName: setWindowBrightness
     * @description: 设置给定Activity的窗口的亮度（可以看到效果，但系统的亮度属性不会改变）
     * @author:  Mr.Lee
    ...
    /**
     * @MethodName:
     * @description: 设置系统亮度并实时可以看到效果，需要WRITE_SETTINGS权限
     * @author:  Mr.Lee
     * @param activity 要通过此Activity来设置窗口的亮度
     * @param screenBrightness 亮度，范围是0-255
     * @return 设置是否成功
    ...
    /**
     * @MethodName: getScreenDormantTime
     * @description: 获取屏幕休眠时间，需要WRITE_SETTINGS权限
     * @author:  Mr.Lee
     * @param context 上下文
    ...
    /**
     * @MethodName: setScreenDormantTime
     * @description: 设置屏幕休眠时间，需要WRITE_SETTINGS权限
     * @author:  Mr.Lee
     * @param context 上下文
     * @param millis    时间
     * @return 设置是否成功
    ...
    /**
     * @MethodName: getAirplaneModeState
     * @description: 获取飞行模式的状态，需要WRITE_APN_SETTINGS权限
     * @author:  Mr.Lee
     * @param context 上下文
    ...
    /**
     * @MethodName: isAirplaneModeOpen
     * @description: 判断飞行模式是否打开，需要WRITE_APN_SETTINGS权限
     * @author:  Mr.Lee
     * @param context 上下文
    ...
    /**
     * @MethodName: setAirplaneMode
     * @description: 设置飞行模式的状态，需要WRITE_APN_SETTINGS权限
     * @author:  Mr.Lee
     * @param context 上下文
    ...
    /**
     * @MethodName: getRingVolume
     * @description: 获取铃声音量，需要WRITE_APN_SETTINGS权限
     * @author:  Mr.Lee
     * @param context 上下文
