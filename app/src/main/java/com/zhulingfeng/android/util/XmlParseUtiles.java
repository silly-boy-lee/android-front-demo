...
/**
 * @ClassName: XmlParseUtiles
 * @description: XML解析工具类 对pull解析xml进行了封装，不用给每个xml，再创建一个对应的解析类
 * @author:  Mr.Lee
 */
...
public class XmlParseUtiles {
    ...
    /**
     * @MethodName: setXmlValue
     * @description: 把xml标签的值，转换成对象里属性的值
     * @author:  Mr.Lee
     * @param t 对象
     * @param name xml标签名
