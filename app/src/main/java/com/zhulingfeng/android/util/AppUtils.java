...
public final class AppUtils {
    ...
    /**
     * @FunctionName: AppUtils
     * @description: 禁用其它类来实例化此类
     * @author:  Mr.Lee
     */
    private AppUtils() {
    ...
    /**
     * @MethodName: getLauncherClassName
     * @description:  获取应用启动界面所对应的Activity的全限定类名
     * @author:  Mr.Lee
     * @param context 应用程序上下文
     * @return 应用程序启动时，第一活动所对应的类名
     */
     ...
     * @author:  Mr.Lee
     * @param context     上下文
     * @param packageName 包名，如：com.tencent.mobileqq
     */
    ...
    /**
     * @MethodName: stopRunningService
     * @description: 停止正在运行的特定服务
     * @author:  Mr.Lee
     * @param context   上下文
     * @param className 类名
     * @return 是否执行成功
    ...
    /**
     * @MethodName: isNamedProcess
     * @description: 检测是否含有当前的进程
     * @author:  Mr.Lee
     * @param context     上下文
    ...
    /**
     * @MethodName: isApplicationInBackground
     * @description:  检测应用程序是否在后台运行
     * @author:  Mr.Lee
     * @param context     上下文
     * @return 当前应用程序是否在后台运行
     */
    ...
    /**
     * @MethodName: getDeviceUsableMemory
     ...
     * @description: 获取系统中所有的应用对应的包信息列表
     * @author:  Mr.Lee
     * @param context 上下文
     * @return 应用信息List
     */
    ...
    /**
     * @MethodName: isDalvik
     * @description: 检测当前运行模式是否是Dalvik模式
     * @author:  Mr.Lee
     * @return true 是Dalvik模式 false 不是Dalvik模式
     */
     ...
     * @description: 是否ART模式
     * @author:  Mr.Lee
     * @return true 是ART模式 false 不是ART模式
     */
    ...
    /**
     * @MethodName: getCurrentRuntimeValue
     * @description: 获取手机当前的Runtime
     * @author:  Mr.Lee
     ...
     * @description: 比较版本号的大小,前者大则返回一个正数,后者大返回一个负数,相等则返回0   支持4.1.2,4.1.23.4.1.rc111这种形式
     * @author:  Mr.Lee
     */
